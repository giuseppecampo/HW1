<html>
    <head>
        ...
        <script src="script_auto.js" defer></script>
    ...
    <header>      
        <nav>
            ...
            <div id="link">
                <a href="HW1.php" class="button"> Home</a>
...
<section>
                  <div>
                  <h1> Prenota la tua Automobile</h1>
                  <label>Nome <input type='text' name='nome' id="nome"></label> <br><br>
                  <label>Nome Auto <input type='text' name='hotel' id="automobile"></label>
                  <label>&nbsp;<input type='submit' id="buttons"></label></div>
</section>
    <footer>
        <p>TravelSecurity</p>
